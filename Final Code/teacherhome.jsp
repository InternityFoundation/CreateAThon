<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import ="java.util.*,dat.*"%>
    ...
    <body class="container-fluid" style="height: 700px;align-content: center">
        ...
        <div class="row">
            <div class="col-lg-2">
                ...
                <div class="container">
                <h4><b><%= new DatabaseConnection().getTeacName((String)session.getAttribute("teac"))%> </b></h4>
              ...
              <%
                    ArrayList<String> q=new DatabaseConnection().getQuestionTeacher((String)session.getAttribute("teac")); 
              %>0 +   
               
            <div class="container" id="myUL">                 
                <p style='margin-left:20px;'><b>Question for you:</b></p>
                <ul style="list-style-type:none;">
                 <%for(String ques:q){ String qw[]=ques.split("#"); %>
                <li class="li1"><a href="teacherpost.jsp?qid=<%=qw[0]%>"><div class="filterDiv"><%=qw[1]%><p><b><%=qw[2]%></b></p></div></a></li>
		...
		<div class="container" align="center">
                    ...
                    <button type="button" class="btn btn-primary" onclick="move_control2()">No</button>
                </div>
            </form>
	</div>
